...
import { User, Mail, Phone, MapPin, Home, Camera, Loader2, CheckCircle2, ArrowLeft, Package, ShoppingBag } from 'lucide-react';
            ...
            <div className="bg-white rounded-[2.5rem] shadow-xl p-8 text-center border border-gray-100">
              <div className="relative inline-block mb-6">
                <div className="w-32 h-32 bg-[#00AA13]/10 rounded-full flex items-center justify-center text-[#00AA13] font-black text-4xl border-4 border-white shadow-inner">
                  {profile.full_name ? profile.full_name.charAt(0).toUpperCase() : userEmail.charAt(0).toUpperCase()}
                </div>
              ...
              <h2 className="text-xl font-black text-gray-900 mb-1">{profile.full_name || 'User SegarTani'}</h2>
              <p className="text-sm font-bold text-gray-400 mb-8">{userEmail}</p>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    <ShoppingBag size={18} className="text-gray-400 group-hover:text-[#00AA13]" />
                    <span className="text-sm font-black text-gray-700 group-hover:text-[#00AA13]">Pesanan Saya</span>
                  </div>
            ...
            <div className="bg-white rounded-[2.5rem] shadow-xl p-8 md:p-12 border border-gray-100">
              <form onSubmit={handleSave} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">NOMOR TELEPON</label>
                    <div className="relative">
                ...
                <div className="pt-6 flex items-center gap-6">
                  ...
                  >
                    {saving ? <Loader2 size={24} className="animate-spin" /> : 'Simpan Perubahan'}
                  </button>
                  {success && (
                    <motion.div 
