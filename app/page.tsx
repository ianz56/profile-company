...
import { CheckCircle2, Truck, Carrot, ShieldCheck, ArrowRight, Users, Mail, Star } from 'lucide-react';
  ...
  const features = [
    {
      ...
      icon: Carrot,
      image: 'https://infopublik.id/resources/album/pertanian-perikanan-perkebunan-peternakan/PANEN_KANGKUNG_DARAT.JPG',
    },
    {
    ...
    },
    {
      ...
      icon: CheckCircle2,
      image: 'https://i1.wp.com/www.agroindustri.id/wp-content/uploads/2017/06/perkebunan-teh-1000x600-1.jpg',
    },
    {
      title: 'Pengiriman Cepat',
      description: 'Pesanan sampai di depan pintu Anda dalam kondisi segar.',
      icon: Truck,
      image: 'https://monitorday.com/wp-content/uploads/2025/03/kurirpaket.webp',
    },
  ];
    ...
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center justify-center text-center">
          ...
          <div className="flex flex-col items-center w-full max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold leading-tight mb-8 text-gray-900 max-w-5xl tracking-tight">
              ...
              Langsung dari <span className="text-[#FF9F1C]">Pasar Tradisional</span>
            </h1>

            <p className="text-lg md:text-xl text-gray-500 mb-12 leading-relaxed max-w-2xl mx-auto font-medium">
              SegarTani menyediakan platform belanja bahan masakan kualitas premium dengan harga terbaik. Penuhi kebutuhan dapur Anda hari ini.
            </p>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6 text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Mengapa SegarTani?</h2>
      ...
      <section className="py-20 bg-[#FAFAFA]">
        <div className="container mx-auto px-6">
          <div className="bg-white rounded-[3rem] shadow-xl p-10 md:p-16 border border-gray-50">
            <div className="text-center mb-16 overflow-hidden">
              <h2 className="text-xl md:text-3xl lg:text-4xl font-black text-black leading-tight whitespace-nowrap">
                Bersama, Kami Tumbuhkan <span className="text-[#00AA13]">Pangan Sehat.</span>
              </h2>
            </div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
              <div>
                <h3 className="text-4xl md:text-5xl font-black text-[#00AA13] mb-3">25+</h3>
                <p className="text-gray-500 font-bold uppercase tracking-widest text-xs md:text-sm">Pasar Mitra</p>
              </div>
              <div>
                <h3 className="text-4xl md:text-5xl font-black text-[#FF9F1C] mb-3">50k+</h3>
                <p className="text-gray-500 font-bold uppercase tracking-widest text-xs md:text-sm">Produk Terjual</p>
              </div>
              <div>
                <h3 className="text-4xl md:text-5xl font-black text-[#00AA13] mb-3">10k+</h3>
                <p className="text-gray-500 font-bold uppercase tracking-widest text-xs md:text-sm">Pelanggan Aktif</p>
              </div>
              <div>
                <h3 className="text-4xl md:text-5xl font-black text-[#FF9F1C] mb-3">24/7</h3>
                <p className="text-gray-500 font-bold uppercase tracking-widest text-xs md:text-sm">Layanan</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="container mx-auto px-6 text-left">
          <div className="max-w-6xl mb-16 pl-4 md:pl-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Card 1 */}
            <div className="bg-white p-10 rounded-[2.5rem] text-left border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
